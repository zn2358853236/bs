...
@Scope("prototype")
public class CheckImgAction extends Struts2ActionSupport {
	@Override
	public String execute() throws Exception {
		...
		// 将生成的字母存入到session中
		this.getSessionMap().put("checkcode", sb.toString());
		...
		ImageIO.write(bufferedImage, "jpg", this.getHttpResponse().getOutputStream());
		return NONE;
	}
